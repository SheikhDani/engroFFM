...
import com.tallymarks.engroffm.models.customerfarmerhierarchyoutput.CustomerFarmerHierarchyoutput;
...
public class GetCustomerFarmerHierarchy  extends AsyncTask<String, Void, Void> {
    ...
    public  GetCustomerFarmerHierarchy (Context context)
    {
    ...
    protected Void doInBackground(String... Url) {
        String response = "";
        String listofAllCrops = Constants.FFM_GET_LIST_OF_CUSTOMERS_FARMER_HIERARCHY;
        ...
        try {
            ...
            Type journeycodeType = new TypeToken<ArrayList<CustomerFarmerHierarchyoutput>>() {
            }.getType();
            List<CustomerFarmerHierarchyoutput> journeycode = new Gson().fromJson(response, journeycodeType);

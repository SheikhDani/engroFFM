...
import com.tallymarks.engroffm.models.listofallproductcategories.ListofAllProductCategoriesOutput;
...
public class GetListofallProductCategories extends AsyncTask<String, Void, Void> {
    ...
    public  GetListofallProductCategories(Context context)
    {
    ...
    protected Void doInBackground(String... Url) {
        ...
        try {
            ...
            Type journeycodeType = new TypeToken<ArrayList<ListofAllProductCategoriesOutput>>() {
            }.getType();
            List<ListofAllProductCategoriesOutput> journeycode = new Gson().fromJson(response, journeycodeType);

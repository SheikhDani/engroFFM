...
import com.tallymarks.engroffm.adapters.FarmersAdapter;
...
import com.tallymarks.engroffm.models.getFarmerTodayJourneyPlan.FarmerTodayJourneyPlan;
            ...
            if (response != null) {
                if (journeycode.size() > 0) {
                    ...
                    for (int j = 0; j < journeycode.size(); j++) {
                        ...
                        map.put(mydb.KEY_TODAY_JOURNEY_IS_VISITED_INTERNET_AVAILALE, "0");

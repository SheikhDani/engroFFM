...
public class ConversionRetentionAdapter extends RecyclerView.Adapter<ConversionRetentionAdapter.MyViewHolder> {
    ...
    @Override
    public ConversionRetentionAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerview_conversion_retention_items, parent, false);

        return new ConversionRetentionAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull ConversionRetentionAdapter.MyViewHolder holder, int position) {

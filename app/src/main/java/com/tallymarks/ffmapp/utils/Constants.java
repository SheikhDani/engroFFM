...
public class Constants {
    ...
    public static final String PLAN_TYPE_MAP= "planTypeMap";
    ...
    public static final String CUSTOM_LAT_SOIL= "customLatsoil";
    public static final String CUSTOM_LNG_SOIL= "customLngsoil";

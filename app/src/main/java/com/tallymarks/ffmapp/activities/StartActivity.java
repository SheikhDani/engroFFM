...
public class StartActivity extends AppCompatActivity {
    ...
    public void addActivity() {
        ...
        headerParams.put(db.KEY_CUSTOMER_TODAY_PLAN_STARTACTIVITY_LATITUDE, shelper.getString(Constants.CUSTOMER_LAT));
        headerParams.put(db.KEY_CUSTOMER_TODAY_PLAN_STARTACTIVITY_LONGITUDE, shelper.getString(Constants.CUSTOMER_LNG));
    ...
    private void updateActivity() {
        ...
        filter.put(db.KEY_TODAY_JOURNEY_CUSTOMER_CODE, shelper.getString(Constants.CUSTOMER_CODE));
    ...
    private boolean isUnpostedDataExist() {
        ...
        filters.put(db.KEY_TODAY_JOURNEY_CUSTOMER_CODE, shelper.getString(Constants.CUSTOMER_CODE));
